...
__decorate([
    (0, typeorm_1.OneToMany)(() => boards_entity_1.Board, (board) => board.user, { onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
    __metadata("design:type", String)
], User.prototype, "boards", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => boards_entity_1.Board, (board) => board.sharedWith),
